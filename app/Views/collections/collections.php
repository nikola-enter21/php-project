...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_PATH ?>/public/assets/collection.css">
    ...
    <div class="page-wrapper">
        ...
        <main>
            <div class="collection-create-container">
                ...
                <?php endif; ?>
                <div class="collection-create-container">
                    <a href="<?= BASE_PATH ?>/collections/create" class="create-collection-btn">
                    ...
                    <?php if (!empty($collections)): ?>
                        <?php foreach ($collections as $collection): ?>
                            <div class="collection-card">
                                ...
                                <a href="<?= BASE_PATH ?>/collections/<?= htmlspecialchars($collection['id']) ?>/export-pdf" class="export-pdf-btn">
                                    Export as PDF
                                </a>
                            </div>
                        <?php endforeach; ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        quoteTitles.forEach(title => {
            title.addEventListener('click', async function () {
                ...
                try {
                    const response = await fetch(`${basePath}/quotes/${quoteId}`);
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', async function () {
                ...
                try {
                    const response = await fetch(`${basePath}/collections/${collectionId}/quotes/${quoteId}/delete`, {
                        method: 'DELETE',
                        headers: {
